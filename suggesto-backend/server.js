    ...
    try {
        ...
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a helpful assistant that suggests movies based on user preferences and the prompt the user inputs."
                },
                {
                    role: "user",
                    content: `Suggest a different movie to watch based on the following preferences: ${prompt}${filterText}.`
                }
            ],
